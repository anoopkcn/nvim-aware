// GENERATED FILE — do not edit. Source: core/snapshot.mjs. Regenerate with `npm run build` (or `node scripts/build.mjs`).
/**
 ...
 *
 * The two Lua expressions encode every selection / quickfix / buffer edge case
 * and must not be rewritten casually.
 */
...
/**
 * Prompt-time snapshot for long-lived hosts: serve from cache within `ttlMs`,
 * otherwise refresh with a short timeout and fall back to the last known
 * snapshot (plus a warning) when Neovim is briefly slow or unavailable.
